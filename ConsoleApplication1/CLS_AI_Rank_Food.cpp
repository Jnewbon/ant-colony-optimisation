...
CLS_AI_Rank_Food::CLS_AI_Rank_Food(void)
{
}
...
CLS_Maze_Cell* CLS_AI_Rank_Food::move(CLS_Maze_Cell* currentCell)
{
...
void CLS_AI_Rank_Food::returnMove(std::vector<CLS_Maze_Cell*> history)
{
	history.back()->removeFood();
...
void CLS_AI_Rank_Food::pheroEvapRule(CLS_Maze_Cell* theGrid, int sizeOfGrid)
{
